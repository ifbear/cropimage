...
extension DDCropViewController {
    ...
    private func refreshUI() {
        ...
        scanningCropView.position = cropModel.rectangle.convert(with: scanningCropView.bounds.width / image.size.width)
        scanningCropView.maxResizeFrame = scanningCropView.bounds
    ...
    @objc private func buttonActionHandler(_ button: UIButton) {
        ...
        case confirmButton:
            ...
            cropModel.rectangle = scanningCropView.position.convert(with: scale)
