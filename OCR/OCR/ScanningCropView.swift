...
protocol ScanningCropViewDelegate: NSObjectProtocol {
    func cropBegin(at point: CGPoint)
    func cropMoved(at point: CGPoint)
    func cropEnded(at potin: CGPoint)
}

class ScanningCropView: UIView {
    //MARK: - 公有属性
    
    /// ScanningCropViewDelegate
    internal weak var delegate: ScanningCropViewDelegate? = nil
